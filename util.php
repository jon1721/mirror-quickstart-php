...
function bootstrap_new_user() {
  ...
  $timeline_item->setText("Bienvenido a la Mirror API PHP Quick Start");

  insert_timeline_item($mirror_service, $timeline_item, null, null);

  insert_contact($mirror_service, "jcfID", "Juan Carlos Fernández",
      $base_url . "/static/images/Jon.jpg");
